// Test suite for enhanced manifold extraction (Co3NeEnhanced)
//
...
bool Test2_EnhancedVsSimplified()
{
    ...
    Co3Ne<double>::Parameters paramsSimple;
    ...
    // Test with Co3Ne (same algorithm used twice for comparison)
