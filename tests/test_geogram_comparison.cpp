    ...
    size_t geoCoTriCount,        size_t gteCoTriCount)
{
    ...
    std::cout << "\n";
    std::cout << "  Remaining minor differences:\n";
    std::cout << "\n";
    std::cout << "  1. Multi-nerve RDT vertices\n";
    std::cout << "     Geogram (RDT_MULTINERVE): adds intersection vertices along Voronoi\n";
    std::cout << "       cell boundaries (edges where adj cells meet), producing ~2-3x\n";
    std::cout << "       more output vertices than seeds (e.g. 2800 for 1000 seeds).\n";
    std::cout << "     GTE: outputs one vertex per seed (RVC centroid) = exactly nb_pts verts.\n";
    std::cout << "     Effect: Geogram output has higher vertex count and smoother boundaries.\n";
    std::cout << "\n";
    ...
    std::cout << "  The only structural difference is Geogram's multi-nerve mode which\n";
    std::cout << "  adds ~2x extra intersection vertices along cell boundaries.\n\n";
